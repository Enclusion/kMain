...
import com.mccritz.kmain.commands.CommandLogout;
...
public class CombatLogListener implements Listener {
	...
	new BukkitRunnable() {
	    @Override
	    public void run() {
		if (CommandLogout.getDontMove().containsKey(e.getPlayer().getUniqueId())) {
		    if (e.getFrom().getBlockX() != e.getTo().getBlockX()
			    || e.getFrom().getBlockY() != e.getTo().getBlockY()
			    || e.getFrom().getBlockZ() != e.getTo().getBlockZ()) {
			CommandLogout.getDontMove().get(e.getPlayer().getUniqueId()).cancel();
			CommandLogout.getDontMove().remove(e.getPlayer().getUniqueId());
			CommandLogout.getCounter().get(e.getPlayer().getUniqueId()).cancel();
			CommandLogout.getCounter().remove(e.getPlayer().getUniqueId());
			CommandLogout.getCount().remove(e.getPlayer().getUniqueId());
