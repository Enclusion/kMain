...
/**
 * A small wrapper for the PacketPlayOutScoreboardTeam packet. Cred to
 * NametagEdit for helping with revoking teams
 */
public class PacketHandler {
    ...
    public void sendToPlayer(Player bukkitPlayer) throws ClassNotFoundException, IllegalAccessException,
