...
public class ItemDb {
    ...
    private kMain kmain = kMain.getInstance();
    ...
    public void onReload() {
        try {
            File file = new File(kMain.getInstance().getDataFolder(), "item.csv");

            if (!file.exists()) {
                Bukkit.getPluginManager().disablePlugin(kMain.getInstance());
            }
