...
public class Register {
	...
	try {
		...
		BaseCommand command = new BaseCommand(commandAnn.name(),
			commandAnn.permission() == null ? null : commandAnn.permission(), commandAnn.commandUsage(),
			commandAnn.aliases()) {
		    @Override
	...
	final CodeSource codeSource = Legacy.getInstance().getClass().getProtectionDomain().getCodeSource();
	...
	if (command == null) {
	    ...
	    command = (PluginCommand) constructor.newInstance(cmd, Legacy.getInstance());
	}
