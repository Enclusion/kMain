...
public class Teleport implements Runnable {
    ...
    public Teleport(UUID id, String warpingMessage, String warpedMessage, Location toLocation, TeleportSetting teleportSetting) {
        this.id = id;
        this.warpingMessage = warpingMessage;
        this.warpedMessage = warpedMessage;
    ...
    public Teleport(UUID id, String warpingMessage, String warpedMessage, int time, Location toLocation, TeleportSetting teleportSetting) {
        this.id = id;
        this.warpingMessage = warpingMessage;
        this.warpedMessage = warpedMessage;
        this.time = time;
    ...
    public Teleport(UUID id, String warpingMessage, String warpedMessage, int time, UUID target, TeleportSetting teleportSetting) {
        this.id = id;
        this.warpingMessage = warpingMessage;
        this.warpedMessage = warpedMessage;
        this.time = time;
