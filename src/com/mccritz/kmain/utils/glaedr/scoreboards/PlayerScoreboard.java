...
public class PlayerScoreboard {
    ...
    /**
     * PlayerScoreboard constructor No need to instantiate this class, it is all
     * done within Glaedr
     *
     * @param player
     */
    ...
    /**
     * This method returns a unique String that will be used to prevent
     * scoreboard flickering It will return null if all ChatColors are currently
     * being used
     *
     * @param entry
     *            Scoreboard Entry
    ...
    /**
     * This method will check whether a boolean in the main class is true, if so
     * it will attempt to "hook" into a players already existing scoreboard. If
     * either the player has no existing scoreboards, or the boolean is false,
     * it will create a new scoreboard along with a new objective.
     */
    ...
    /**
     * @param player
     *            Player paramater, required to compare names
    ...
    /**
     * @param entry
     *            Used to determine if entry is already contained in map, etc
