...
public class Command_tpaccept extends BaseCommand {

    public Command_tpaccept() {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if (profile.isTeleportRequestHere()) {
            ...
            final Teleport teleportRunnable = new Teleport(target.getUniqueId(), "&7You are now being teleported to &c" + player.getName() + "&7.\nWait 5 seconds. Do not move.", "&7You have teleported to &c" + player.getDisplayName() + "&7.", 10, player.getUniqueId(), new TeleportSetting() {
                @Override
            ...
            MessageManager.sendMessage(player, "&7You have accepted the request for &c" + target.getName() + " &7to teleport to you.");
            ...
            final Teleport teleportRunnable = new Teleport(player.getUniqueId(), "&7You are now being teleported to &c" + teleportTo.getName() + "&7.\nWait 5 seconds. Do not move.", "&7You have teleported to &c" + teleportTo.getName() + "&7.", 10, teleportTo.getUniqueId(), new TeleportSetting() {
                @Override
                public void onTeleport(Teleport teleport, Player player) {
            ...
            MessageManager.sendMessage(teleportTo, "&c" + player.getName() + " &7has accepted your request to teleport to them.");
