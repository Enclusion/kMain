...
public class Command_tpahere extends BaseCommand {

    public Command_tpahere() {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if (Bukkit.getPlayer(args[0]) != null) {
            ...
            if (Cooldowns.tryCooldown(player.getUniqueId(), "TPACooldown", 15000)) {
                ...
                MessageManager.sendMessage(player, "&7You have sent a request to teleport to &c" + target.getName() + "&7.");
